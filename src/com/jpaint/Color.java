...
public class Color {
    ...
    static int alphaBlend(int src_int, int dst_int) {
        ...
        float src_a_n = src[0] / 255.0f; //normalized source alpha
        ...
        if(dst_a_int == 255) { //if destination is fully opaque
            ...
            out[0] = 255; //output should be opaque
            ...
            float dst_a_n = dst_a_int / 255.0f; //normalized destination alpha

            ///// out_a = src_a + dst_a * (1 - src_a) /////
            float out_a_n = (src_a_n + (dst_a_n * (1 - src_a_n))); //normalized output alpha

            out[0] = (int)(out_a_n * 255); //get alpha as int btw 0-255
            if(out[0] == 0) return 0b00000000000000000000000000000000; //if totally transparent, return all 0s
    ...
    //get channel of an argb integer
    ...
    //slightly less optimized algorithm:
    static int alphaBlend1(int src_int, int dst_int) {
